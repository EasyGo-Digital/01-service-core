...
public interface PasswordControllerApi {
    ...
    ResponseEntity<Boolean> generate(//@RequestAttribute(value = JwtConstants.JWT_USER_CONTEXT, required = false) RequestContextDto requestContext,
                                     @Valid @PathVariable(name = RestApiConstants.type) IEnumAuth.Types type,
    ...
    ResponseEntity<AccessResponseDto> getAccess(//@RequestAttribute(value = JwtConstants.JWT_USER_CONTEXT, required = false) RequestContextDto requestContext,
